...
export const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col md:flex-row">
      ...
      {/* Sidebar Navigation */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 bg-slate-950 text-slate-300 transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-auto md:w-72 flex flex-col border-r border-slate-800 shadow-2xl ${
      ...
      >
        ...
        <nav
          ...
          className="flex-1 overflow-y-auto p-4 space-y-1 text-left"
        >
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <Icon className="w-4 h-4 shrink-0 text-slate-400 group-hover:text-white" aria-hidden="true" />
        ...
        <div className="p-4 border-t border-slate-800/80 space-y-2">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white text-xs font-semibold transition-colors"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-red-950/40 hover:bg-red-900/60 text-red-300 hover:text-red-100 text-xs font-semibold transition-colors border border-red-900/30 cursor-pointer"
          >
